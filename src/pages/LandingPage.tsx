...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-900 to-slate-950 text-slate-200 flex flex-col items-center justify-center p-6">
      <div className="max-w-3xl text-center space-y-8">
        <div className="flex justify-center items-center gap-3 text-blue-500 font-black text-4xl mb-4">
          <Box size={48} />
          <span className="tracking-tighter uppercase">Pharmalog</span>
        </div>

        <h1 className="text-5xl md:text-7xl font-black text-white tracking-tighter">
          Controle de Faltas <br />
          <span className="text-blue-500 text-3xl md:text-5xl">
            RJ01 & RJ07
          </span>
        </h1>

        <p className="text-xl text-slate-400 leading-relaxed">
          Plataforma inteligente para monitoramento de faltas e gestão de rotas
          farmacêuticas em tempo real.
        </p>

        <button
          onClick={() => navigate("/dashboard")}
          className="group bg-blue-600 hover:bg-blue-500 text-white px-10 py-5 rounded-2xl font-bold text-xl transition-all flex items-center gap-3 mx-auto shadow-2xl shadow-blue-600/20 cursor-pointer"
        >
          Entrar no Sistema
...
//       // // Monitoramento em tempo real de ocorrências rj01 e rj07 para as rotas
//       868, 900 e 750. // //{" "}
//     </p>
//     // //{" "}
...
//         Dados consolidados das faltas por região e categoria.
//       </p>
//       // //{" "}
//     </div>
//     // //{" "}
...
//       // //{" "}
//       <p className="text-slate-400 leading-relaxed">
//         Controle total sobre o desempenho das rotas principais.
//       </p>
//       // //{" "}
//     </div>
//     // //{" "}
...
//       // //{" "}
//       <p className="text-slate-400 leading-relaxed">
//         Separação rigorosa entre medicamentos e perfumaria.
//       </p>
//       // //{" "}
//     </div>
//     // //{" "}
